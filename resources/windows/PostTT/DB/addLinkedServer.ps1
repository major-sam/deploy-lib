...
if($svcs.contains("srvapkbb9.gkbaltbet.local")){ 
    $svcs
    Write-Host "srvapkbb9.gkbaltbet.local allready linked"
}
else{
    invoke-sqlcmd -Query "sp_addlinkedserver  [srvapkbb9.gkbaltbet.local]" | Out-Null
}
