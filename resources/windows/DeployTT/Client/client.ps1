...
try {
    $json_appsetings.Services.CalculateRequestHost = "$($apiAddr)"
} catch {
    Write-Host -ForegroundColor Green "[WARN] Field Services/CalculateRequestHost does not exists. Skip it..."
}
