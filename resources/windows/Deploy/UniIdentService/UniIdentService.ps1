...
$json_appsetings.LegacyTokenAuthentication.DecryptionKey = $env:UniIdentServiceDecryptionKey
$json_appsetings.LegacyTokenAuthentication.ValidationKey = $env:UniIdentServiceValidationKey
